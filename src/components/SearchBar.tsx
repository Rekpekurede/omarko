    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="relative">
        ...
        <input
          ...
          className="h-11 w-full rounded-lg border border-border bg-bg-card px-4 pl-10 text-sm text-text-primary placeholder:text-text-muted focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
          aria-label="Search"
        />
      </div>
    </form>
